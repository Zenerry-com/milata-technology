...
import { ChevronRight, Truck, Trees, Globe } from 'lucide-react';
...
const Hero = () => {
  return (
    <section id="home" className="relative pt-28 pb-20 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-5 z-0"></div>
      
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 animate-fade-in">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              <span className="text-milata-white">Advanced Solutions for </span>
              <span className="text-milata-limeGreen">Road & Land Management</span>
            </h1>
            
            <p className="text-milata-greyGreen text-lg md:text-xl mb-8 max-w-lg">
              Innovative technology and sustainable practices for highway maintenance, 
              forestry management, and environmental stability.
            </p>
        ...
        <div className="mt-20 border-t border-milata-greyGreen/20 pt-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="glass-card p-6 rounded-lg">
              ...
              <p className="text-milata-greyGreen">Years of Experience</p>
            </div>
            
            <div className="glass-card p-6 rounded-lg">
              <h3 className="text-milata-limeGreen text-4xl font-bold mb-2">300+</h3>
              <p className="text-milata-greyGreen">Projects Completed</p>
            </div>
            
            <div className="glass-card p-6 rounded-lg">
              <h3 className="text-milata-limeGreen text-4xl font-bold mb-2">50+</h3>
              <p className="text-milata-greyGreen">Specialized Vehicles</p>
            </div>
          </div>
        </div>
      </div>
